...
.info{
    ...
    <?php        include 'connect.php'; ?>
        ...
        <div class="content">           
             <table class="tb" align="center" border="1" width="900px" >
        <tr align="center"  class="truong" >
            <td class="title">Infomation</td>
            <td class="title" colspan="2">Option</td>
            
        </tr>
        <?php 
		$sql= "select * from users where Type like '%cus%' ";
	...
	?>
        <tr>
            <td class="info" align="left"><?php echo 'ID: '.$rows['Id']; ?><br>
            <?php echo 'Username: '.$rows['UserName']; ?><br>
          <?php  echo 'Full name: '.$rows['FullName']; ?><br>
          <?php echo 'Birthday: '.$rows['Birthday']; ?><br>
            <?php echo 'Phone number: '.$rows['Phone']; ?><br>
          <?php  echo 'Email: '.$rows['Email']; ?><br>
          <?php echo 'Address: '.$rows['Address']; ?><br>
            <?php echo 'Rank: '.$rows['IdRank']; ?><br>         
            </td>
            <td class="op" align="center" width="150px">
                <a href="customer_update_rank.php?Id=<?php echo $rows['Id'];?>">Update Rank</a>
            </td>
            <td class="op" align="center" width="150px">
                <a href="customer_delete.php?Id=<?php echo $rows['Id'];?>" onclick="return confirm('Are you want to delete this?');">Delete account</a>
            </td>
        </tr>
<?php } 
