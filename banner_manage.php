...
<html lang="en" dir="ltr">
    ...
    <?php        include 'connect.php'; ?>
        ...
        <div class="content">
             ...
             <table class="tb" align="center" border="1" width="800px" >
        <tr align="center"  class="truong" >
            <td class="title">Picture</td>
            <td class="title">ID</td>
            <td class="title">Name</td>           
            <td class="title"><a  href="banner_manage_add.php">Import Banner</a></td>
        </tr>
        <?php 
	...
	?>
        <tr align="center">
            <td><img src="image/<?php echo $rows['image_banner'] ?>" width="300" height="150" /></td>
            <td><?php echo $rows['id_banner']; ?></td>
            <td><?php echo $rows['name_banner']; ?></td>                  
           
            <td class="op">
                <a href="banner_manage_delete.php?id_banner=<?php echo $rows['id_banner'];?>" onclick="return confirm('Are you want to delete this?');">Delete</a>
            </td>
        </tr>
<?php } 
