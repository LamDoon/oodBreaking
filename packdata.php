...
<html lang="en" dir="ltr">
    ...
    <?php        include 'connect.php'; ?>
        ...
        <tr align="center"  class="truong" >
            ...
            <td class="title">Thông Tin</td>  
            <td class="title">Đơn Giá</td>
            <td colspan="2"class="title"><a  href="pack1_add.php">Thêm GC</a></td>
        </tr>
        <?php 
		$sql= "select * from packofdata order by Id desc ";
	...
	?>
        <tr align="center">
            ...
            <td><?php echo $rows['Infomation']; ?></td>
            <td><?php echo $rows['Price']; ?></td>          
            
            <td class="op">
                <a href="pack_update.php?Id=<?php echo $rows['Id'];?>">Update</a>
            </td>
            <td class="op">
                <a href="pack_delete.php?Id=<?php echo $rows['Id'];?>" onclick="return confirm('Are you want to delete this?');">Delete</a>
            </td>
        </tr>
<?php } 
