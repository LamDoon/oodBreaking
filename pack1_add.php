...
<body>
    ...
    <form action="pack2_add.php" method="post" enctype="multipart/form-data" name="form1">
        <table class="tb" align="left"  >
            <tr >
            <td class="title" align="right">ID Gói</td>
            <td class="txt"><input type="text" name="Id" value="" required="" size="48"/></td>
        </tr>
        <tr >
            <td class="title" align="right">Tên</td>
            <td class="txt"><input type="text" name="Name" value="" required="" size="48" /></td>
        </tr>
            <tr >
            <td class="title" align="right">Code</td>
            <td class="txt"><input type="text" name="code" value="" required="" size="48" /></td>
        </tr>
        <tr >
            <td class="title" align="right">Thông Tin</td>
            <td class="txt"><textarea rows="9" cols="50" name="Infomation"></textarea> </td>
        </tr>
        <tr >
            <td class="title" align="right">Đơn Giá</td>
            <td class="txt" ><input type="text" name="Price" value=""required="" size="48" /></td>
        </tr>        
        <tr >
